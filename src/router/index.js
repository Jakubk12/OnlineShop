...
const router = createRouter({
    ...
    routes: [
        ...
        {
          path: '/pages/:id', component: CategoriesComponent
        },
        {
          path: '/pages/contact', component: ContactComponent
        },
        {
          path: '/Items', component: AccesoriesComponent
        },
        {
          path: '/Items/:id', component: ManComponent
        },
        {
          path: '/Items/Woman', component: WomanComponent
        }
