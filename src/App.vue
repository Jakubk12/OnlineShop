...
//import accesories from "./items/accesories.json";
...
export default {
  ...
  setup() {
    ...
    const accesories = ref([
      ...
      {
        name: "BECO",
        model: "Boxy BLDC Nightstand Graphic Blue 309135 ",
        type: "Winder",
        country: "Germany",
